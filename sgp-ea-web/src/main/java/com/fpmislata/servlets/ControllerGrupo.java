...
public class ControllerGrupo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/ListarGrupo")) {
    ...
    private void listarGrupos(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List lista = grupoService.listGrupos();
            ArrayList<Grupo> listaArrayGrupo = new ArrayList(lista);
            request.getSession().setAttribute("grupo", listaArrayGrupo);
            RequestDispatcher rd = request.getRequestDispatcher("/listarGrupos.jsp");
